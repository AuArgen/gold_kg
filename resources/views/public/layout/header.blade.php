    ...
    <div class="navbar max-w-7xl mx-auto">
        ...
        <div class="navbar-center hidden lg:flex">
            <ul class="menu menu-horizontal px-1 gap-2">
                ...
                {{-- Контакт (Используем routeIs для примера, вам нужно будет создать маршрут 'public.contact') --}}
                <li>
                    <a href="/"
                       class="btn btn-ghost btn-sm text-base-content {{ request()->is('/') ? 'btn-active bg-base-200' : '' }}">
                        Контакт
                    </a>
                </li>
                {{-- Кабинет --}}
        ...
        <div class="navbar-end">
            ...
            <div class="dropdown dropdown-end lg:hidden ml-2">
                ...
                <ul tabindex="0" class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow-lg border border-base-200">
                    ...
                    <li><a href="/" class="{{ request()->is('/') ? 'active font-semibold' : '' }}">Контакт</a></li>
