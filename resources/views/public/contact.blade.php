...
@section('title', 'Контакты | ' . env('APP_NAME'))
@section('description', 'Свяжитесь с нами, чтобы получить актуальную информацию о ценах на золото и консультации по инвестициям.')
    ...
    <div class="max-w-7xl mx-auto my-12 px-4 sm:px-6 lg:px-8">
        ...
        <header class="text-center py-10 mb-8 bg-base-100 rounded-2xl shadow-xl">
            ...
            <p class="text-lg text-base-content/80 max-w-2xl mx-auto">
                Мы всегда готовы ответить на ваши вопросы о ценах на золото, условиях покупки и инвестиционных возможностях.
            </p>
        </header>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="card bg-base-100 shadow-2xl border border-base-300">
                <form class="card-body" method="POST" action="{{route('public.submit_contact')}}">
                    {{-- Обратите внимание: я исправил маршрут на public.contact.submit,
                         так как это стандартное имя из последнего контроллера и роутов,
                         вместо public.submit-contact --}}
                    @csrf
                    <h2 class="card-title text-2xl font-bold text-secondary mb-4">Отправьте нам сообщение</h2>

                    {{-- Имя --}}
                    <label class="form-control w-full">
                        <div class="label"><span class="label-text font-medium">Ваше имя</span></div>
                        <input type="text" name="name" placeholder="Иван Иванов" class="input input-bordered w-full bg-base-200 @error('name') input-error @enderror" value="{{ old('name') }}" required />
                    ...
                    <label class="form-control w-full mt-2">
                        ...
                        <textarea name="message" class="textarea textarea-bordered h-24 w-full bg-base-200 @error('message') textarea-error @enderror" placeholder="Ваш вопрос или предложение..." required>{{ old('message') }}</textarea>
            ...
            <div>
                <h2 class="text-3xl font-bold text-base-content mb-6">Наши данные</h2>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center space-x-4 p-4 bg-base-200 rounded-lg shadow-md">
                        ...
                        <div>
                            <p class="text-base-content/70 text-sm">Телефон</p>
                    ...
                    <div class="flex items-center space-x-4 p-4 bg-base-200 rounded-lg shadow-md">
                        ...
                        <div>
                            <p class="text-base-content/70 text-sm">Email для вопросов</p>
                    ...
                    <div class="flex items-center space-x-4 p-4 bg-base-200 rounded-lg shadow-md">
                        ...
                        <div>
                            <p class="text-base-content/70 text-sm">Адрес офиса</p>
                            <p class="text-lg font-semibold text-base-content">г. Бишкек, ул. Ибраимова, 103</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 rounded-lg overflow-hidden shadow-xl border border-base-300">
                    <h3 class="text-center p-3 bg-base-200 font-medium text-base-content">Наше местоположение</h3>
